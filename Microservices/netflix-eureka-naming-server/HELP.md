...
* The original package name 'com.example.microservice.netflix-eureka-naming-server' is invalid and this project uses 'com.example.microservice.netflixeurekanamingserver' instead.
